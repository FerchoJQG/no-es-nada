...
**Rol:** Servidor de Aplicación 1 (Node.js en puerto 3000)
...
Si hay error de conexión, verifica con Limbert que la DB esté lista y que el usuario `usr_movies` tiene permisos desde `192.168.107.3`.
...
```bash
# Detén tu app (el proxy de Fernando debería redirigir todo a Melany)
pm2 stop app1_3000
